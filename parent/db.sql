...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/systemManage'), '区域管理/查看', '/sysAreaInfo/listJson', 2, null, 'glyphicon-th', 1, '查看', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/sysAreaInfo';
