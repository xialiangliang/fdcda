...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) select SEQ_SYS_RESOURCE.nextval, ID, ID, '我的VIP', '/customerInfo/vipList', 1, 2, 'glyphicon-th', 1, '我的VIP', sysdate, sysdate from SYS_RESOURCE where URL = '/customer';
