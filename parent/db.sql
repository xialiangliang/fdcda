...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) select SEQ_SYS_RESOURCE.nextval, ID, ID, '黑名单审核', '/sysBlackCheck', 1, 2, 'glyphicon-th', 7, '黑名单审核', sysdate, sysdate from SYS_RESOURCE where URL = '/systemManage';
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) select SEQ_SYS_RESOURCE.nextval, ID, ID, '区域管理', '/sysAreaInfo', 1, 2, 'glyphicon-th', 7, '区域管理', sysdate, sysdate from SYS_RESOURCE where URL = '/systemManage';
...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) select SEQ_SYS_RESOURCE.nextval, ID, ID, '我的交易', '/order', 1, 2, 'glyphicon-th', 1, '我的交易', sysdate, sysdate from SYS_RESOURCE where URL = '/systemManage';
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) select SEQ_SYS_RESOURCE.nextval, ID, ID, '交易评价', '/evaluate', 1, 2, 'glyphicon-th', 1, '交易评价', sysdate, sysdate from SYS_RESOURCE where URL = '/systemManage';
...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) select SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/customer'), '添加黑名单', '/blackList/newBlack/list', 1, 3, 'glyphicon-th', 2, '添加黑名单', sysdate, sysdate from SYS_RESOURCE where URL = '/blackList';
...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/systemManage'), '删除', '/sysResource/delete', 2, null, 'glyphicon-th', 2, '资源管理/删除', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/sysResource';

INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/systemManage'), '角色管理/查看', '/sysRole/listJson', 2, null, 'glyphicon-th', 1, '查看', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/sysRole';
...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/systemManage'), '查看', '/sysAreaInfo/listJson;/sysAreaInfo/find', 2, null, 'glyphicon-th', 1, '区域管理/查看', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/sysAreaInfo';
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/systemManage'), '新增', '/sysAreaInfo/new;/sysAreaInfo/save', 2, null, 'glyphicon-th', 1, '区域管理/新增', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/sysAreaInfo';
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/systemManage'), '修改', '/sysAreaInfo/find;/sysAreaInfo/update', 2, null, 'glyphicon-th', 1, '区域管理/修改', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/sysAreaInfo';
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/systemManage'), '删除', '/sysAreaInfo/delete', 2, null, 'glyphicon-th', 1, '区域管理/删除', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/sysAreaInfo';

INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/systemManage'), '查看', '/sysUser/listJson', 2, null, 'glyphicon-th', 1, '人员管理/查看', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/sysUser';
...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/systemManage'), '查看列表', '/sysOutlets/listJson', 2, null, 'glyphicon-th', 1, '门店管理/查看列表', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/sysOutlets';
...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/systemManage'), '查看登录记录', '/sysPlatform/listJson', 2, null, 'glyphicon-th', 2, '查看登录记录', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/sysPlatform';

INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/systemManage'), '黑名单审核列表', '/sysBlackCheck/listJson;/sysBlackCheck/find', 2, null, 'glyphicon-th', 1, '黑名单审核列表', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/blackList';
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/systemManage'), '黑名单审核', '/sysBlackCheck/check', 2, null, 'glyphicon-th', 1, '黑名单审核', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/blackList';
...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/customer'), '采购商管理/导入', '/customerInfo/batchnew;/customerInfo/batchnew/save;/customerInfo/download', 2, null, 'glyphicon-th', 1, '导入', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/customerInfo';
...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/customer'), '添加用户黑名单', '/blackList/user/new;/blackList/user/save', 2, null, 'glyphicon-th', 2, '添加用户黑名单', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/blackList/user';
...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/customer'), '添加黑名单列表', '/blackList/newBlack/list/listJson;/blackList/newBlack/list', 2, null, 'glyphicon-th', 2, '添加黑名单列表', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/blackList/newBlack';
...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/analysis'), '查看', '/order/listJson;/order/find', 2, null, 'glyphicon-th', 1, '我的订单/查看', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/order';
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/analysis'), '新增', '/order/new;/order/save', 2, null, 'glyphicon-th', 1, '我的订单/新增', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/order';
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/analysis'), '修改', '/order/find;/order/update', 2, null, 'glyphicon-th', 1, '我的订单/修改', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/order';
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/analysis'), '删除', '/order/delete', 2, null, 'glyphicon-th', 1, '我的订单/删除', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/order';

INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/analysis'), '查看', '/evaluate/listJson;/evaluate/find', 2, null, 'glyphicon-th', 1, '我的订单/查看', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/evaluate';
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/analysis'), '新增', '/evaluate/new;/evaluate/save', 2, null, 'glyphicon-th', 1, '我的订单/新增', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/evaluate';
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/analysis'), '修改', '/evaluate/find;/evaluate/update', 2, null, 'glyphicon-th', 1, '我的订单/修改', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/evaluate';
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/analysis'), '删除', '/evaluate/delete', 2, null, 'glyphicon-th', 1, '我的订单/删除', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/evaluate';
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/analysis'), '评价', '/evaluate/detail', 2, null, 'glyphicon-th', 1, '我的订单/评价', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/evaluate';