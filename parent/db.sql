...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, NAME, URL, TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, '采购商管理/添加黑名单', '/customerInfo/addToBlackList', 2, 'glyphicon-th', 4, '添加黑名单', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/customerInfo';
