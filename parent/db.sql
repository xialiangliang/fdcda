...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) VALUES (SEQ_SYS_RESOURCE.nextval, 0, SEQ_SYS_RESOURCE.currval, '经营分析', '/analysis', 1, 1, 'glyphicon-th', 2, '经营分析', sysdate, sysdate);
...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) select SEQ_SYS_RESOURCE.nextval, ID, ID, '采购商管理', '/customerInfo', 1, 2, 'glyphicon-th', 1, '采购商管理', sysdate, sysdate from SYS_RESOURCE where URL = '/customer';
...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/customer'), '查看用户黑名单', '/blackList/user/listJson', 2, null, 'glyphicon-th', 2, '查看用户黑名单', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/blackList/user';
...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/customer'), '黑名单管理/申请系统黑名单', '/blackList/user/applySystemBlacklist', 3, null, 'glyphicon-th', 2, '申请系统黑名单', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/blackList/user';
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/customer'), '查看系统黑名单', '/blackList/system/listJson', 2, null, 'glyphicon-th', 2, '查看系统黑名单', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/blackList/system';
