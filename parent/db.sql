...
INSERT INTO SYS_RESOURCE (ID, PARENT_ID, TOP_ID, NAME, URL, TYPE, MENU_TYPE, ICON, SORT, MEMO, CREATE_TIME, MODIFY_TIME) SELECT SEQ_SYS_RESOURCE.nextval, ID, (select ID from SYS_RESOURCE WHERE URL = '/systemManage'), '黑名单审核列表', '/sysBlackCheck/check', 2, null, 'glyphicon-th', 1, '黑名单审核列表', sysdate, sysdate FROM SYS_RESOURCE WHERE url = '/blackList';
