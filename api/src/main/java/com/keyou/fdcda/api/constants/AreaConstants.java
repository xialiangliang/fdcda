...
public class AreaConstants {
    public static String AreaJsonStr = "{" +
            "    \"countries\": [" +
            "        {" +
            "            \"country\": \"中国\"," +
            "            \"provinces\": [" +
    ...
    public static Map<Long, Object> countryMap = new HashMap<Long, Object>() {{
        put(1L, new HashMap<String, Object>(){{
            put("name", "中国");
            put("subMap", new HashMap<Long, Object>(){{
            }});
        }});
    }};
    ...
    static {
        areaMap = (Map<String, Object>) JSONUtils.parse(AreaJsonStr);
    }
